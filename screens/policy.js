      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <SafeAreaView style={styles.safeContainer}>
            ...
            <Text style={styles.policyText}>Money growth built the Money growth app as a Free app. This SERVICE is provided by Money growth at no cost and is intended for use as is.
...
The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at Money growth unless otherwise defined in this Privacy Policy.

Information Collection and Use

For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to United States . The information that we request will be retained by us and used as described in this privacy policy.
...
const styles = StyleSheet.create({
  ...
  safeContainer: {
    ...
    paddingHorizontal: '5%', // Use a percentage of the screen width for padding
    // paddingTop: 20,
  },
  policyTitle: {
    fontSize: 24,
